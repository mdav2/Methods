...
# Pull in Hartree-Fock data, including integrals
    ...
    def compute_CAS(self, active_space ='',nfrozen=0, nvirtual=0):
        ...
        aref = '1'*self.ndocc + '0'*self.nvir
        self.ref = Det(a=aref, b = aref)
        ...
        # Debug
        #for i,de in enumerate(self.determinants):
        #    if de - self.ref == 4:
        #        x = H_dif4(self.ref, de, self.h, self.Vint)
        #        if abs(x) > 1e-9:
        #            print(self.ref.phase(de))
        #prob = self.determinants[59]
        #print(self.ref)
        #print(prob)
        #print(self.ref.phase(prob))
        return self.Ecas
